	...
	override public function new(house:House):Void
	{
		...
		for (i in 0...200)
		{
			if (i <= RegHouse._totalPurchased)
			{
				...
				_sprite.loadGraphic("myLibs/house/assets/images/house/furniture/get/" + RegHouse._sprite_number[i] + ".png", true, 100, 100);
				add(_sprite);
			...
			else
			{
				...
				// load the furniture images.
				_sprite = new FlxSprite();
				_sprite.loadGraphic("myLibs/house/assets/images/houseItem.png", true, 100, 100);
				_group.add(_sprite);
	...
	public static function textAndspriteRefreshPanel():Void
	{
		for (i in 0...200)
		{
			if (i <= RegHouse._totalPurchased)
			{
				...
				_group_sprite[i].loadGraphic("myLibs/house/assets/images/house/furniture/get/" + RegHouse._sprite_number[i] + ".png", true, 100, 100);
				_group_sprite[i].animation.add("0", [0], 30, false);
				_group_sprite[i].animation.add("1", [1], 30, false);
				_group_sprite[i].animation.play("0");
			}
			...
			else if (_group_text[i] != null)
			{
				...
				_group_sprite[i].loadGraphic("myLibs/house/assets/images/houseItem.png", true, 100, 100);
				_group_sprite[i].animation.add("0", [0], 30, false);
				_group_sprite[i].animation.play("0");
