...
class HouseMapWallUp extends FlxSprite 
{
	...
	public function new (x:Float, y:Float, house:House, id:Int, stack_order:Int, xID:Int, yID:Int)
	{
		...
		if (stack_order == 0)
			loadGraphic("myLibs/house/assets/images/house/foundation/put/walls/"+RegHouse._wall_up_in_front[_tileX][_tileY]+".png", true, 109, 212);
		else
			loadGraphic("myLibs/house/assets/images/house/foundation/put/walls/"+RegHouse._wall_up_behind[_tileX][_tileY]+".png", true, 109, 212);
	...
	override public function update(elapsed:Float)
	{
		...
		&&  ActionInput.coordinateY() - HouseScrollMap._map_offset_y < FlxG.height - 55 + HouseScrollMap._map_offset_y )
		{
			...
			{
				loadGraphic("myLibs/house/assets/images/house/foundation/put/walls/"+ (__house.__house_foundation_put._item_Selected_id-__house.__house_foundation_put._floorTotal) +".png", true, 109, 212);
				animation.add("2", [2], 30, false);
				animation.play("2");
		...
		if (ActionInput.pressed() == true)
		{
			...
			&&  ActionInput.coordinateY() - HouseScrollMap._map_offset_y < FlxG.height - 55 + HouseScrollMap._map_offset_y )
			{
				...
				&&  __house._hover_p_value == _id)
				{
					loadGraphic("myLibs/house/assets/images/house/foundation/put/walls/0.png", true, 109, 212);
