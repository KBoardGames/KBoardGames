	...
	override public function new(house:House):Void
	{
		...
		for (i in 0...200)
		{
			if (RegHouse._namesCanPurchase[i] != null)
			{
				...
				_sprite.loadGraphic("myLibs/house/assets/images/house/furniture/get/" + i + ".png", true, 100, 100);
				_group.add(_sprite);
			...
			else
			{
				...
				// load the furniture images.
				_sprite = new FlxSprite();
				_sprite.loadGraphic("myLibs/house/assets/images/houseItem.png", false, 100, 100);
				_group.add(_sprite);
