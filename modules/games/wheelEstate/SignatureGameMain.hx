...
class SignatureGameMain extends FlxState
{
	...
	*/
	...
	public function initialize():Void
	{
		...
		if (Reg._gameDiceMaximumIndex[Reg._move_number_next] == 27 && Reg._gameYYnew2 == 7 && Reg._gameXXnew2 == 7
		||  Reg._gameDiceMaximumIndex[Reg._move_number_next] == 27 && Reg._gameYYnew2 == 0 && Reg._gameXXnew2 == 0)
		_unitImage.loadGraphic("modules/games/wheelEstate/assets/images/7.png", false);
		else _unitImage.loadGraphic("modules/games/wheelEstate/assets/images/"+(Reg._gameDiceMaximumIndex[Reg._move_number_next])+".png", false);
		...
		if (Reg._gameDiceMaximumIndex[Reg._move_number_next] == 27 && Reg._gameYYnew2 == 7 && Reg._gameXXnew2 == 7
		||  Reg._gameDiceMaximumIndex[Reg._move_number_next] == 27 && Reg._gameYYnew2 == 0 && Reg._gameXXnew2 == 0)
		_unitImageDebt.loadGraphic("modules/games/wheelEstate/assets/images/7.png", false);
		else _unitImageDebt.loadGraphic("modules/games/wheelEstate/assets/images/"+(Reg._gameDiceMaximumIndex[Reg._move_number_next])+".png", false);
...
._cash[Reg._move_number_next] += _sellAllServicesPrice;
	...
	*/
	...
	private function buttonResetTradeProposal():Void
	{
		if (Reg._game_offline_vs_cpu == true)
		{
			//_unitYoursImage.loadGraphic("modules/games/wheelEstate/assets/images/empty.png", false);
			//_unitOthersImage.loadGraphic("modules/games/wheelEstate/assets/images/empty.png", false);
		}
	...
	override public function update(elapsed:Float):Void 
	{
		...
		&&  RegTriggers._displayDebtStuff == true)
		{
			...
			if (Reg._gameUniqueValueForPiece[Reg._gameYYold][Reg._gameXXold] - 1 == Reg._move_number_current && RegTypedef._dataPlayers._cash[Reg._move_number_current] < _totalDebtAmount)
			{
				...
				_unitImageDebt.loadGraphic("modules/games/wheelEstate/assets/images/"+_p2+".png", false);
