...
class SnakesAndLaddersImagesCapturingUnits extends FlxSprite 
{
	...
	public function new (xx:Float, yy:Float, id, xID:Int, yID:Int)
	{
		...
		&&  Reg._game_offline_vs_player == false)
		{
			...
			if (_id == 3) loadGraphic("modules/games/snakesAndLadders/assets/images/player/19.png", false);
			if (_id == 4) loadGraphic("modules/games/snakesAndLadders/assets/images/player/14.png", false);
		}
		else
		{
			if (_id == 1) loadGraphic("assets/images/capturingUnitsNoTransparency2.png", false);
			if (_id == 2) loadGraphic("assets/images/capturingUnitsNoTransparency1.png", false);
			if (_id == 3) loadGraphic("modules/games/snakesAndLadders/assets/images/player/14.png", false);
			if (_id == 4) loadGraphic("modules/games/snakesAndLadders/assets/images/player/19.png", false);
		}
