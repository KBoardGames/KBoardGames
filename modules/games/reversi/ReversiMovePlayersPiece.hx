...
class ReversiMovePlayersPiece extends FlxSprite {
	...
	public function new (y:Float, x:Float, pieceValue:Int, id:Int)
	{
		...
		else loadGraphic("modules/games/reversi/assets/images/" + pieceValue + ".png", false); // load the different game pieces.
	...
	private function displayImage(yy:Int, xx:Int):Void
	{
		if (Reg._otherPlayer == false)
		{
			...
			{
				loadGraphic("modules/games/reversi/assets/images/1.png", false);
				Reg._gamePointValueForPiece[yy][xx] = 1;
			}
			else
			{
				loadGraphic("modules/games/reversi/assets/images/11.png", false);
