		...
		if (Reg._gameId == 1)
		{
			...
			*/
			...
			else
			{
				...
				if (Reg._gameDidFirstMove == true && Reg._gameMovePiece == false && Reg._capturingUnitsForImages[Reg._playerMoving][_yID][_xID] > 0 &&  RegCustom._capturing_units[Reg._tn] == true
				) 
					visible = true;
