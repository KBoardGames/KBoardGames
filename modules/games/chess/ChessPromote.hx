...
{	
	...
	public function new():Void
	{
		...
		if (Reg._chessPawnPromotedMessage == false)
		{
			...
			_bishop.loadGraphic("modules/chess/assets/images/" + (2 + _num) + ".png", false);
			_bishop.scrollFactor.set(0, 0);
			add(_bishop);
			
			var _horse = new FlxSprite(FlxG.width / 2 - 75, FlxG.height / 2);
			_horse.loadGraphic("modules/chess/assets/images/" + (3 + _num) + ".png", false);
			_horse.scrollFactor.set(0, 0);
			add(_horse);
			
			var _rook = new FlxSprite(FlxG.width / 2, FlxG.height / 2);
			_rook.loadGraphic("modules/chess/assets/images/" + (4 + _num) + ".png", false);
			_rook.scrollFactor.set(0, 0);
			add(_rook);
			
			var _queen = new FlxSprite(FlxG.width / 2 + 75, FlxG.height / 2);
			_queen.loadGraphic("modules/chess/assets/images/" + (5 + _num) + ".png", false);
