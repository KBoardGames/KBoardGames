	...
	override public function new(house:House):Void
	{
		...
		for (i in 0...200)
		{
			if (i <= RegHouse._totalPurchased)
			{
				...
				_sprite.loadGraphic("assets/images/house/furniture/get/" + RegHouse._sprite_number[i] + ".png", true, 100, 100);
				add(_sprite);
			...
			else
			{
				...
				// load the furniture images.
				_sprite = new FlxSprite();
				_sprite.loadGraphic("assets/images/houseItem.png", true, 100, 100);
				_group.add(_sprite);
