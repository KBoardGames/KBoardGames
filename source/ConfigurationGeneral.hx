...
class ConfigurationGeneral extends CID2
{
	...
	override public function new(menu_configurations_output:ConfigurationOutput):Void
	{
		...
		CID2._text_empty = new ButtonGeneralNetworkNo(0, CID2._button_menu_bar_background_number_plus.y + 250, "", 100, 35, Reg._font_size, RegCustom._button_text_color[Reg._tn], 0, null, RegCustom._button_color[Reg._tn]);
	...
	public function sceneGeneral():Void
	{
		...
		CID2._text_title_odd_units.setFormat(Reg._fontDefault, Reg._font_size);
		...
		CID2._text_odd_units_shade.setFormat(Reg._fontDefault, Reg._font_size);
		...
		CID2._text_title_even_units.setFormat(Reg._fontDefault, Reg._font_size);
		...
		CID2._text_even_units_shade.setFormat(Reg._fontDefault, Reg._font_size);
		...
		CID2._text_odd_units_color.setFormat(Reg._fontDefault, Reg._font_size);
		...
		CID2._text_even_units_color.setFormat(Reg._fontDefault, Reg._font_size);
		...
		CID2._gameboard_border_title.setFormat(Reg._fontDefault, Reg._font_size);
	...
	CID2._button_gameboard_border_plus.label.font = Reg._fontDefault;
		...
		CID2._question_gameboard_border_enabled.setFormat(Reg._fontDefault, Reg._font_size);
	...
	private function gameboard_coordinates():Void
	{
		...
		CID2._question_gameboard_coordinates_enabled.setFormat(Reg._fontDefault, Reg._font_size);
	...
	private function notation_panel_10_percent_alpha():Void
	{
		...
		CID2._question_notation_panel_10_percent_alpha_enabled = new TextGeneral(15, CID2._button_gameboard_coordinates_enabled.height + CID2._button_gameboard_coordinates_enabled.y + CID2._offset_rows_y, 800, "Apply 40% transparency to the notation panel?");
		CID2._question_notation_panel_10_percent_alpha_enabled.setFormat(Reg._fontDefault, Reg._font_size);
	...
	private function notation_panel_same_background_color():Void
	{
		...
		CID2._question_notation_panel_same_background_color .setFormat(Reg._fontDefault, Reg._font_size);
		...
		CID2._group.add(CID2._group_button[13]);
		//-----------------------------
	}
	...
	private function notation_panel_background_color():Void
	{
		...
		CID2._question_notation_panel_background_color.setFormat(Reg._fontDefault, Reg._font_size);
	...
	private function notation_panel_text_color():Void
	{
		...
		CID2._question_notation_panel_text_color_number.setFormat(Reg._fontDefault, Reg._font_size);
		...
		//-----------------------------
		CID2._question_notation_panel_enabled = new TextGeneral(15, CID2._question_notation_panel_text_color_number.height + CID2._question_notation_panel_text_color_number.y + (CID2._offset_rows_y * 2) + 10, 800, "Display the notation panel?");
		CID2._question_notation_panel_enabled.setFormat(Reg._fontDefault, Reg._font_size);
	...
	private function gameboard_even_units_show():Void
	{
		...
		var _question_gameboard_even_units_show_enabled = new TextGeneral(15, CID2._button_notation_panel_enabled.height + CID2._button_notation_panel_enabled.y + CID2._offset_rows_y, 800, "Show even gameboard units?");
	...
	private function background_alpha():Void
	{
		...
		CID2._question_background_alpha_enabled = new TextGeneral(15, CID2._button_gameboard_even_units_show_enabled.height + CID2._button_gameboard_even_units_show_enabled.y + CID2._offset_rows_y, 800, "Apply a 50% transparency to the gradient background?", 8, true);
		CID2._question_background_alpha_enabled.setFormat(Reg._fontDefault, Reg._font_size);
	...
	private function gradient_background():Void
	{
		_num += 1;
		//----------------------------
		CID2._question_gradient_background_enabled = new TextGeneral(15, CID2._button_background_alpha_enabled.height + CID2._button_background_alpha_enabled.y + CID2._offset_rows_y, 800, "Display a gradient background?\r\n\r\n");
		CID2._question_gradient_background_enabled.setFormat(Reg._fontDefault, Reg._font_size);
		...
		CID2._sprite_gradient_background_image = new FlxSprite(CID2._button_gradient_texture_background_plus.x + 50, CID2._button_gradient_texture_background_enabled.y, "assets/images/gameboardGradientBackground" + Std.string(RegCustom._gradient_background_image_number[Reg._tn]) + "b.jpg");
	...
	private function texture_background():Void
	{
		...
		_question_texture_background_enabled.setFormat(Reg._fontDefault, Reg._font_size);
	...
	private function client_single_color_background():Void
	{
		...
		var _question_client_background_enabled = new TextGeneral(15, CID2._button_client_texture_background_enabled.height + CID2._button_client_texture_background_enabled.y + (CID2._offset_rows_y * 4) - 5, 800, "Display a single color background? Select false for a random color background. A gradient or texture background can still be seen if transparency is enabled.", 8, true, true);
		_question_client_background_enabled.setFormat(Reg._fontDefault, Reg._font_size);
	...
	private function client_background_brightness():Void
	{
		...
		CID2._question_client_background_brightness = new TextGeneral(15, CID2._button_client_background_enabled.height + CID2._button_client_background_enabled.y + CID2._offset_rows_y * 2, 800, "Single color background brightness? 0 is black. 1 is full bright.", 8, true, true);
		CID2._question_client_background_brightness.setFormat(Reg._fontDefault, Reg._font_size);
		...
		CID2._text_client_background_brightness.setFormat(Reg._fontDefault, Reg._font_size);	
		...
		// this needs to be placed here to display both this brightness text and the static background image above from the RegCustomColors.color_client_background because that function updates both variables. 
	...
	private function client_background_saturation():Void
	{
		...
		CID2._question_client_background_saturation = new TextGeneral(15, CID2._button_client_background_brightness_minus.height + CID2._button_client_background_brightness_minus.y + CID2._offset_rows_y, 800, "Single color background saturation? 0 is pure gray. 1 is vibrant.", 8, true, true);
		CID2._question_client_background_saturation.setFormat(Reg._fontDefault, Reg._font_size);
		...
		CID2._text_client_background_saturation.setFormat(Reg._fontDefault, Reg._font_size);	
	...
	private function leaderboard_enable():Void
	{
		...
		//----------------------------
		CID2._question_leaderboard_enabled = new TextGeneral(15, CID2._button_client_background_saturation_minus.height + CID2._button_client_background_saturation_minus.y + CID2._offset_rows_y, 800, "Show leading competitors in various game statistics? (leaderboard.)", 8, true, true);
		CID2._question_leaderboard_enabled.setFormat(Reg._fontDefault, Reg._font_size);
	...
	private function house_feature_enable():Void
	{
		...
		CID2._house_feature_question.setFormat(Reg._fontDefault, Reg._font_size);
	...
	private function return_to_lobby_after_save():Void
	{
		...
		CID2._question_goto_title.setFormat(Reg._fontDefault, Reg._font_size);
	...
	{	
		...
		CID2._question_start_game_request.setFormat(Reg._fontDefault, Reg._font_size);
	...
	private function start_game_offline_without_confirmation():Void
	{
		...
		CID2._question_start_game_offline_confirmation.setFormat(Reg._fontDefault, Reg._font_size);
	...
	private function accept_start_game_request_entering_game_room():Void
	{
		...
		CID2._question_accept_start_game_request.setFormat(Reg._fontDefault, Reg._font_size);
	...
	private function waiting_room_confirmation_return_to_lobby():Void
	{
		...
		CID2._question_to_lobby_waiting_room_confirmation.setFormat(Reg._fontDefault, Reg._font_size);
	...
	private function game_room_confirmation_return_to_lobby():Void
	{
		...
		CID2._question_to_lobby_game_room_confirmation.setFormat(Reg._fontDefault, Reg._font_size);
	...
	private function waiting_room_confirmation_entering_game_room():Void
	{
		...
		CID2._question_to_game_room_from_waiting_room.setFormat(Reg._fontDefault, Reg._font_size);
	...
	private function confirmation_before_returning_to_title():Void
	{
		...
		CID2._question_to_title_from_game_room.setFormat(Reg._fontDefault, Reg._font_size);
	...
	private function chat_turn_off_for_lobby():Void
	{
		...
		CID2._question_chat_turn_off_for_lobby.setFormat(Reg._fontDefault, Reg._font_size);
	...
	private function move_timer_enable():Void
	{
		...
		CID2._question_move_timer_enabled.setFormat(Reg._fontDefault, Reg._font_size);
	...
	private function display_players_move_total_text():Void
	{
		...
		CID2._question_move_total_enabled.setFormat(Reg._fontDefault, Reg._font_size);
	...
	private function capturing_units_enable():Void
	{
		...
		CID2._question_capturing_units_enabled.setFormat(Reg._fontDefault, Reg._font_size);
	...
	private function button_colors():Void
	{
		...
		CID2._question_button_colors.setFormat(Reg._fontDefault, Reg._font_size);
		...
		CID2._question_button_colors_output.setFormat(Reg._fontDefault, Reg._font_size);
	...
	private function music_enable():Void
	{
		...
		CID2._question_music_enabled.setFormat(Reg._fontDefault, Reg._font_size);
	...
	private function sound_enable():Void
	{
		...
		CID2._question_sound_enabled.setFormat(Reg._fontDefault, Reg._font_size);
	...
	private function title_bar_color():Void
	{
		...
		CID2._question_title_bar_background_number.setFormat(Reg._fontDefault, Reg._font_size);
	...
	private function menu_bar_color():Void
	{
		...
		CID2._question_menu_bar_background_number = new TextGeneral(15, CID2._button_title_bar_background_number_minus.height + CID2._button_title_bar_background_number_minus.y + CID2._offset_rows_y, 800, "Background color of scene footer menu?");
		CID2._question_menu_bar_background_number.setFormat(Reg._fontDefault, Reg._font_size);
	...
	private function buttonNumber(_val:Int = 0):Void
	{
		...
		switch (_val)
		{
			...
			case 12: __e.notation_panel_alpha();
			case 13: __e.notation_panel_same_background_color();
			case 14: __e.notation_background_color();
			case 15: __e.notation_panel_background_color_minus();
			case 16: __e.notation_panel_background_color_plus();
			case 17: __e.notation_panel_text_color_minus();
			case 18: __e.notation_panel_text_color_plus();
			case 19: __e.notation_panel_enabled();
			case 20: __e.gameboard_even_units_show_enabled();
			case 21: __e.client_background_alpha();
			case 22: __e.client_gradient_background_enabled();
			case 23: __e.client_gradient_background_number_minus();
			case 24: __e.client_gradient_background_number_plus();
			case 25: __e.client_texture_background_enabled();
			case 26: __e.client_texture_background_number_minus();
			case 27: __e.client_texture_background_number_plus();
			case 28: __e.client_background_enabled();
			case 29: __e.client_background_number_minus();
			case 30: __e.client_background_number_plus();
			case 31: __e.client_background_brightness_minus();
			case 32: __e.client_background_brightness_plus();		
			case 33: __e.client_background_saturation_minus();
			case 34: __e.client_background_saturation_plus();		
			case 35: __e.leaderboards_enabled();
			case 36: __e.house_feature_enabled();
			case 37: __e.go_back_to_title_after_save();
			case 38: __e.automatic_game_request();
			case 39: __e.start_game_offline_confirmation();
			case 40: __e.accept_automatic_game_request();
			case 41: __e.to_lobby_waiting_room_confirmation();
			case 42: __e.to_lobby_game_room_confirmation();
			case 43: __e.to_game_room_confirmation();
			case 44: __e.to_title_confirmation();
			case 45: __e.chat_turn_off_lobby();
			case 46: __e.chat_turn_off_room();
			case 47: __e.move_timer_enabled();
			case 48: __e.move_total_enabled();			
			case 49: __e.capturing_units_enabled();
			case 50: __e.capturing_units_minus();
			case 51: __e.capturing_units_plus();
			case 52: __e.button_background_color();
			case 53: __e.button_border_color();
			case 54: __e.button_text_color();
			case 55: __e.music_enabled();
			case 56: __e.sound_enabled();
			case 57: __e.title_bar_background_enabled();
			case 58: __e.title_bar_background_number_minus();
			case 59: __e.title_bar_background_number_plus();
			case 60: __e.menu_bar_background_enabled();
			case 61: __e.menu_bar_background_number_minus();
			case 62: __e.menu_bar_background_number_plus();
		}
	}
