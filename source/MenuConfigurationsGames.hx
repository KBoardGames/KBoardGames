...
class MenuConfigurationsGames extends FlxGroup
{
	...
	*/
	...
	public function sceneGames():Void
	{
		...
		var _checkers_minus_minutes = new ButtonGeneralNetworkNo(_title_checkers_game_minutes.fieldWidth + 40, _title_checkers_game_minutes.y - 10, "-", 40, 40, Reg._font_size, RegCustom._button_text_color[Reg._tn], 0, null, RegCustom._button_color[Reg._tn]);
		...
		var _checkers_plus_minutes = new ButtonGeneralNetworkNo(_checkers_minus_minutes.x + 90, _title_checkers_game_minutes.y - 10, "+", 40, 40, Reg._font_size, RegCustom._button_text_color[Reg._tn], 0, null, RegCustom._button_color[Reg._tn]);		
		...
		var _chess_minus_minutes = new ButtonGeneralNetworkNo(_title_chess_game_minutes.fieldWidth + 40, _title_chess_game_minutes.y - 10, "-", 40, 40, Reg._font_size, RegCustom._button_text_color[Reg._tn], 0, null, RegCustom._button_color[Reg._tn]);
		...
		var _chess_plus_minutes = new ButtonGeneralNetworkNo(_chess_minus_minutes.x + 90, _title_chess_game_minutes.y - 10, "+", 40, 40, Reg._font_size, RegCustom._button_text_color[Reg._tn], 0, null, RegCustom._button_color[Reg._tn]);
		...
		var _reversi_minus_minutes = new ButtonGeneralNetworkNo(_title_reversi_game_minutes.fieldWidth + 40, _title_reversi_game_minutes.y - 10, "-", 40, 40, Reg._font_size, RegCustom._button_text_color[Reg._tn], 0, null, RegCustom._button_color[Reg._tn]);
		...
		var _reversi_plus_minutes = new ButtonGeneralNetworkNo(_reversi_minus_minutes.x + 90, _title_reversi_game_minutes.y - 10, "+", 40, 40, Reg._font_size, RegCustom._button_text_color[Reg._tn], 0, null, RegCustom._button_color[Reg._tn]);
		...
		var _snakes_ladders_minus_minutes = new ButtonGeneralNetworkNo(_title_snakes_ladders_game_minutes.fieldWidth + 40, _title_snakes_ladders_game_minutes.y - 10, "-", 40, 40, Reg._font_size, RegCustom._button_text_color[Reg._tn], 0, null, RegCustom._button_color[Reg._tn]);
		...
		var _snakes_ladders_plus_minutes = new ButtonGeneralNetworkNo(_snakes_ladders_minus_minutes.x + 90, _title_snakes_ladders_game_minutes.y - 10, "+", 40, 40, Reg._font_size, RegCustom._button_text_color[Reg._tn], 0, null, RegCustom._button_color[Reg._tn]);
		...
		var _signature_minus_minutes = new ButtonGeneralNetworkNo(_title_signature_game_minutes.fieldWidth + 40, _title_signature_game_minutes.y - 10, "-", 40, 40, Reg._font_size, RegCustom._button_text_color[Reg._tn], 0, null, RegCustom._button_color[Reg._tn]);
		...
		var _signature_plus_minutes = new ButtonGeneralNetworkNo(_signature_minus_minutes.x + 90, _title_signature_game_minutes.y - 10, "+", 40, 40, Reg._font_size, RegCustom._button_text_color[Reg._tn], 0, null, RegCustom._button_color[Reg._tn]);		
		...
		_button_game_skill_level_chess = new ButtonGeneralNetworkNo(_text_game_skill_level_chess.x + _text_game_skill_level_chess.fieldWidth + 15, _text_game_skill_level_chess.y - 10, "", 240, 40, Reg._font_size, RegCustom._button_text_color[Reg._tn], 0, null, RegCustom._button_color[Reg._tn]);
		...
		_button_chess_opening_moves_enabled = new ButtonGeneralNetworkNo(_question_chess_opening_moves_enabled.width + 30, _question_chess_opening_moves_enabled.y - 8, "", 100, 35, Reg._font_size, RegCustom._button_text_color[Reg._tn], 0, null, RegCustom._button_color[Reg._tn]);
		...
		_button_chess_show_last_piece_moved = new ButtonGeneralNetworkNo(_question_chess_show_last_piece_moved.width + 30, _question_chess_show_last_piece_moved.y - 8, "", 100, 35, Reg._font_size, RegCustom._button_text_color[Reg._tn], 0, null, RegCustom._button_color[Reg._tn]);
		...
		_button_chess_computer_thinking_enabled = new ButtonGeneralNetworkNo(_question_chess_computer_thinking_enabled.width + 30, _question_chess_computer_thinking_enabled.y - 8, "", 100, 35, Reg._font_size, RegCustom._button_text_color[Reg._tn], 0, null, RegCustom._button_color[Reg._tn]);
		...
		_button_chess_future_capturing_units_enabled = new ButtonGeneralNetworkNo(_question_chess_future_capturing_units_enabled.width + 20, _question_chess_future_capturing_units_enabled.y + 10, "", 100, 35, Reg._font_size, RegCustom._button_text_color[Reg._tn], 0, null, RegCustom._button_color[Reg._tn]);
		...
		_button_chess_path_to_king_enabled = new ButtonGeneralNetworkNo(_question_chess_path_to_king_enabled.width + 10, _question_chess_path_to_king_enabled.y + 10, "", 100, 35, Reg._font_size, RegCustom._button_text_color[Reg._tn], 0, null, RegCustom._button_color[Reg._tn]);
		...
		var _question_chess_set_for_player1 = new FlxText(15, 0, 0, "Player 1 chess piece set.");
		_question_chess_set_for_player1.setFormat(Reg._fontDefault, Reg._font_size);
		_question_chess_set_for_player1.y = _question_chess_path_to_king_enabled.height + _question_chess_path_to_king_enabled.y + 40;
		_group.add(_question_chess_set_for_player1);
		
		_button_chess_set_for_player1_minus = new ButtonGeneralNetworkNo(_question_chess_set_for_player1.width + 30, _question_chess_set_for_player1.y - 8, "", 35, 35, Reg._font_size, RegCustom._button_text_color[Reg._tn], 0, null, RegCustom._button_color[Reg._tn]);
		...
		_button_chess_set_for_player1_plus = new ButtonGeneralNetworkNo(_question_chess_set_for_player1.width + 30 + 50, _question_chess_set_for_player1.y - 8, "", 35, 35, Reg._font_size, RegCustom._button_text_color[Reg._tn], 0, null, RegCustom._button_color[Reg._tn]);
		...
		_sprite_display_pawn_from_p1_chess_set = new FlxSprite(_button_chess_set_for_player1_plus.x + _button_chess_set_for_player1_plus.width + 120, _button_chess_set_for_player1_plus.y + 18);
		...
		_sprite_display_bishop_from_p1_chess_set = new FlxSprite(_button_chess_set_for_player1_plus.x + _button_chess_set_for_player1_plus.width + 120 + 90, _button_chess_set_for_player1_plus.y + 18);
		...
		_sprite_display_horse_from_p1_chess_set = new FlxSprite(_button_chess_set_for_player1_plus.x + _button_chess_set_for_player1_plus.width + 120 + (2 * 90), _button_chess_set_for_player1_plus.y + 18);
		...
		_sprite_display_rook_from_p1_chess_set = new FlxSprite(_button_chess_set_for_player1_plus.x + _button_chess_set_for_player1_plus.width + 120 + (3 * 90), _button_chess_set_for_player1_plus.y + 18);
		...
		_sprite_display_queen_from_p1_chess_set = new FlxSprite(_button_chess_set_for_player1_plus.x + _button_chess_set_for_player1_plus.width + 120 + (4 * 90), _button_chess_set_for_player1_plus.y + 18);
		...
		_sprite_display_king_from_p1_chess_set = new FlxSprite(_button_chess_set_for_player1_plus.x + _button_chess_set_for_player1_plus.width + 120 + (5 * 90), _button_chess_set_for_player1_plus.y + 18);
		...
		var _question_chess_set_for_player1_color = new FlxText(15, 0, 0, "chess piece set color 1.");
		_question_chess_set_for_player1_color.setFormat(Reg._fontDefault, Reg._font_size);
		_question_chess_set_for_player1_color.y = _question_chess_set_for_player1.height + _question_chess_set_for_player1.y + 40;
		_group.add(_question_chess_set_for_player1_color);
		
		_button_chess_set_for_player1_color_minus = new ButtonGeneralNetworkNo(_question_chess_set_for_player1_color.width + 30, _question_chess_set_for_player1_color.y - 8, "", 35, 35, Reg._font_size, RegCustom._button_text_color[Reg._tn], 0, null, RegCustom._button_color[Reg._tn]);
		...
		_button_chess_set_for_player1_color_plus = new ButtonGeneralNetworkNo(_question_chess_set_for_player1_color.width + 30 + 50, _question_chess_set_for_player1_color.y - 8, "", 35, 35, Reg._font_size, RegCustom._button_text_color[Reg._tn], 0, null, RegCustom._button_color[Reg._tn]);
		...
		var _question_chess_set_for_player2 = new FlxText(15, 0, 0, "Player 2 chess piece set.");
		_question_chess_set_for_player2.setFormat(Reg._fontDefault, Reg._font_size);
		_question_chess_set_for_player2.y = _button_chess_set_for_player1_color_plus.height + _button_chess_set_for_player1_color_plus.y + 40;
		_group.add(_question_chess_set_for_player2);
		
		_button_chess_set_for_player2_minus = new ButtonGeneralNetworkNo(_question_chess_set_for_player2.width + 30, _question_chess_set_for_player2.y - 8, "", 35, 35, Reg._font_size, RegCustom._button_text_color[Reg._tn], 0, null, RegCustom._button_color[Reg._tn]);
		...
		_button_chess_set_for_player2_plus = new ButtonGeneralNetworkNo(_question_chess_set_for_player2.width + 30 + 50, _question_chess_set_for_player2.y - 8, "", 35, 35, Reg._font_size, RegCustom._button_text_color[Reg._tn], 0, null, RegCustom._button_color[Reg._tn]);
		...
		_sprite_display_pawn_from_p2_chess_set = new FlxSprite(_button_chess_set_for_player2_plus.x + _button_chess_set_for_player2_plus.width + 120, _button_chess_set_for_player2_plus.y + 18);
		...
		_sprite_display_bishop_from_p2_chess_set = new FlxSprite(_button_chess_set_for_player2_plus.x + _button_chess_set_for_player2_plus.width + 120 + 90, _button_chess_set_for_player2_plus.y + 18);
		...
		_sprite_display_horse_from_p2_chess_set = new FlxSprite(_button_chess_set_for_player2_plus.x + _button_chess_set_for_player2_plus.width + 120 + (2 * 90), _button_chess_set_for_player2_plus.y + 18);
		...
		_sprite_display_rook_from_p2_chess_set = new FlxSprite(_button_chess_set_for_player2_plus.x + _button_chess_set_for_player2_plus.width + 120 + (3 * 90), _button_chess_set_for_player2_plus.y + 18);
		...
		_sprite_display_queen_from_p2_chess_set = new FlxSprite(_button_chess_set_for_player2_plus.x + _button_chess_set_for_player2_plus.width + 120 + (4 * 90), _button_chess_set_for_player2_plus.y + 18);
		...
		_sprite_display_king_from_p2_chess_set = new FlxSprite(_button_chess_set_for_player2_plus.x + _button_chess_set_for_player2_plus.width + 120 + (5 * 90), _button_chess_set_for_player2_plus.y + 18);
		...
		var _question_chess_set_for_player2_color = new FlxText(15, 0, 0, "chess piece set color 2.");
		_question_chess_set_for_player2_color.setFormat(Reg._fontDefault, Reg._font_size);
		_question_chess_set_for_player2_color.y = _question_chess_set_for_player2.height + _question_chess_set_for_player2.y + 40;
		_group.add(_question_chess_set_for_player2_color);
		
		_button_chess_set_for_player2_color_minus = new ButtonGeneralNetworkNo(_question_chess_set_for_player2_color.width + 30, _question_chess_set_for_player2_color.y - 8, "", 35, 35, Reg._font_size, RegCustom._button_text_color[Reg._tn], 0, null, RegCustom._button_color[Reg._tn]);
		...
		_button_chess_set_for_player2_color_plus = new ButtonGeneralNetworkNo(_question_chess_set_for_player2_color.width + 30 + 50, _question_chess_set_for_player2_color.y - 8, "", 35, 35, Reg._font_size, RegCustom._button_text_color[Reg._tn], 0, null, RegCustom._button_color[Reg._tn]);
	...
	{
		RegCustom._chess_set_for_player1_color[Reg._tn] -= 1;
		if (RegCustom._chess_set_for_player1_color[Reg._tn] == 0) RegCustom._chess_set_for_player1_color[Reg._tn] = 40;
	...
	{
		RegCustom._chess_set_for_player1_color[Reg._tn] += 1;
		if (RegCustom._chess_set_for_player1_color[Reg._tn] == 41) RegCustom._chess_set_for_player1_color[Reg._tn] = 1;
	...
	{
		RegCustom._chess_set_for_player2_color[Reg._tn] -= 1;
		if (RegCustom._chess_set_for_player2_color[Reg._tn] == 0) RegCustom._chess_set_for_player2_color[Reg._tn] = 40;
	...
	{
		RegCustom._chess_set_for_player2_color[Reg._tn] += 1;
		if (RegCustom._chess_set_for_player2_color[Reg._tn] == 41) RegCustom._chess_set_for_player2_color[Reg._tn] = 1;
