...
{		
	...
	override public function new() 
	{
		...
		if (Reg._game_offline_vs_player == true || Reg._game_offline_vs_cpu == true || Reg._game_online_vs_cpu == true)
			_image_profile_avatar_p1.loadGraphic("multiavatar/" + RegCustom._profile_avatar_number1);
		else _image_profile_avatar_p1.loadGraphic("multiavatar/" + RegTypedef._dataPlayers._avatarNumber[0]);		
		...
		{
			_image_profile_avatar_p2.loadGraphic("multiavatar/" + RegCustom._profile_avatar_number2);
		}
		...
		&& 		 Reg._game_online_vs_cpu == false)
		{
			...
			_image_profile_avatar_p2.loadGraphic("multiavatar/" + Reg2._offline_cpu_avatar_number[_num]);	
		}
		...
		else if (Reg._game_online_vs_cpu == true)
		{
			if (Reg._gameId == 1)
			{
				for (i in 0...5)
				{
					...
					{
						_image_profile_avatar_p2.loadGraphic("multiavatar/" + Reg2._offline_cpu_avatar_number[i]);	
					}
		...
		else _image_profile_avatar_p2.loadGraphic("multiavatar/" + RegTypedef._dataPlayers._avatarNumber[1]);	
		...
		if (Reg._game_offline_vs_player == true)
			_image_profile_avatar_p3.loadGraphic("multiavatar/" + RegCustom._profile_avatar_number3);
		else _image_profile_avatar_p3.loadGraphic("multiavatar/" + RegTypedef._dataPlayers._avatarNumber[2]);			
		...
		if (Reg._game_offline_vs_player == true)
			_image_profile_avatar_p4.loadGraphic("multiavatar/" + RegCustom._profile_avatar_number4);
		else _image_profile_avatar_p4.loadGraphic("multiavatar/" + RegTypedef._dataPlayers._avatarNumber[3]);			
