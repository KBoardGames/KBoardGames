...
{		
	...
	*/ 
	...
	public function new(_textForYesButton:String = "Yes", _textForNoButton:String = "No", setButtonActive:Bool = true, delayDisplayMessageBox = false) 
	{
		...
		_button4 = new ButtonUnique((FlxG.width - 180) / 2 + 10, (FlxG.height - 343) / 2 + 249, "OK. ", 160 + 15, 35, 20, 0xFFCCFF33, 0, output);
		...
		_buttonMessageOK = new ButtonUnique((FlxG.width - 1204) / 2 + 10, (FlxG.height - 727) / 2 + 252, "OK. ", 160 + 15, 35, 20, 0xFFCCFF33, 0, messageWasRead);
		...
		_button5 = new ButtonUnique((FlxG.width - 1204) / 2 - 60, (FlxG.height - 727) / 2 + 252, "D: " + _textForYesButton + ". ", 135 + 15, 35, 20, 0xFFCCFF33, 0, messageWasRead);
		...
		_button6 = new ButtonUnique((FlxG.width - 1204) / 2 + 105, (FlxG.height - 727) / 2 + 252, "F: " + _textForNoButton + ". ", 135 + 15, 35, 20, 0xFFCCFF33, 0, cancelWasPressed);
