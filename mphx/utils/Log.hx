...
{
    var None = 0;
	public static var Warnings = 0;  //Large messages, weird behaviour
	public static var Errors = 1;    //Socket drops, corrupt data
	public static var Info = 2;      //Serialization method, start/stop of server...
	public static var Networking = 3;//Every message sent and received.
